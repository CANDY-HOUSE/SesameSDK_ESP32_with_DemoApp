# ESP32-C3 Sesame5 Switch Control Example

This project demonstrates how to use the ESP32-C3 microcontroller to register and control a Sesame5 smart lock. Utilizing the ESP-IDF development framework and BLE technology, this example automatically searches for, connects to, and registers nearby Sesame5 devices. When the ESP32-C3 detects that the Sesame5 is in the unlock position, it issues a command to automatically lock it.
...
3. Connect your ESP32-C3 to your computer via USB.
4. Return to the project folder and run `idf.py flash` to compile and flash.

## Usage
After flashing and rebooting the ESP32-C3, it will automatically search for unregistered Sesame devices nearby. Once connected and registered, the ESP32-C3 will monitor the status of the Sesame5 and issue a lock command at the appropriate time.
